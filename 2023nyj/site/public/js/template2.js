        ...
        function threeStepAutoHeight(){
            ...
            $threeStepBox.each(function(){
                if($window.width() > 640) {
                    ...
                    var $threeDescMaxHeight = Math.max.apply(Math, $threeDescHeightArray);
                    ...
                    var $threeInnerMaxHeight = Math.max.apply(Math, $threeInnerHeightArray),
        ...
        function fourStepAutoHeight(){
            ...
            $fourStepBox.each(function(){
                if($window.width() > 640) {
                    ...
                    var $fourDescMaxHeight = Math.max.apply(Math, $fourDescHeightArray);
                    ...
                    var $fourInnerMaxHeight = Math.max.apply(Math, $fourInnerHeightArray),
